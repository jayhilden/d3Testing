    ...
    */
    ...
    function initNodes(data) {
        ...
        if (data) {
            ...
            while (--i > -1) {
                ...
                n = getChild(d);
                d.nodes.push(n);
                n.ext.currents[shortTimeFormat(d.eventDate)] = (n.ext.currents[shortTimeFormat(d.eventDate)] || 0);
                n.ext.currents[shortTimeFormat(d.eventDate)]++;
                ...
                })(shortTimeFormat(d.eventDate)), null);
    ...
    function tick() {
        if (_force.nodes()) {
            ...
            //_force.nodes().forEach(cluster(0.025));
        ...
        if (tooltip.style("display") == "none") {
            ...
            if (d.type == typeNode.parent) {
                ...
                res = [
                    ...
                    "</b><br/>Date: <b>",
                    shortTimeFormat(d.nodeValue.contract.eventDate),
                    "</b><hr/>Project: <b>",
